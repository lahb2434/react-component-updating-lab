...
class Timer extends Component {
  ...
  componentDidUpdate(){
    this.timer.current.style.color = "#" + Math.floor(Math.random() * 11000215).toString(16);
    this.timer.current.style.background = "#" + Math.floor(Math.random() * 16555215).toString(16);
  }
